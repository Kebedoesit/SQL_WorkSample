...
#52 of the instances  lasted between 1 and 3 minutes
 ...
 order by duration desc 
 limit 10;
 #created view looking at the country, duration, and purpose columns of the 10 rows containing the longest durations, in other words maximum values(10)
 select country, duration, purpose 
 from `extra-vehicular_activity__eva__-_us_and_russia` 
 order by duration asc 
 limit 10;
 #created view looking at the country, duration, and purpose columns of the 10 rows containing the shortest durations, or minimum values(10)